export const images: any = {
  ...
  profile_card_filled: require('./profile_card_filled/profile_card_filled.png'),
  settings_slider: require('./settings_slider/settings_slider.png'),
  appearance: require('./appearance/appearance.png'),
  add_filled: require('./add_filled/add_filled.png'),
  help_filled: require('./help_filled/help_filled.png'),
  calendar: require('./calendar/calendar.png'),
  location_tick: require('./location_tick/location_tick.png'),
  user_circle: require('./user_circle/user_circle.png'),
  short_term_rentals: require('./short_term_rentals/short_term_rentals.png'),
  dollar_coins: require('./dollar_coins/dollar_coins.png'),
  presention_chart: require('./presention_chart/presention_chart.png'),
};
