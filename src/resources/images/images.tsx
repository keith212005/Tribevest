...
export const images = {
  ...
  wealthquest: require('./wealthquest/wealthquest.png'),
  nicedaytribe: require('./nicedaytribe/nicedaytribe.png'),
  friendsforever: require('./friendsforever/friendsforever.png'),
