...
export const en = {
  ...
  LARGE_REAL_ESTATE_DEAL: 'Large Real Estate Deal',
  ...
  BANKING: 'Banking',
  TRIBEVEST_ACCOUNT: 'Tribevest Account',
  ADD: 'Add',
  ...
  NO_SAVED_RECIPIENTS_YET: 'No saved recipients yet',
  ADD_RECIPIENTS_GET_STARTED: 'Add a recipient to get started',
  ...
  INVALID_NAME_MSG: 'Enter valid name',
  INVALID_ROUTING_NUMBER_MSG: 'Enter valid routing number',
  INVALID_ACCOUNT_NUMBER_MSG: 'Enter valid account number',
  ACCOUNT_TYPE: 'Account Type',
  NO_PAYMENTS_FOUND: 'No Payments Found',
  CAP_LEDGER: 'Cap Ledger',
  TOTAL_CONTRIBUTIONS: 'Total Contributions',
  PERSONAL: 'Personal',
  TRIBE: 'Tribe',
  MY_LAST_CONTRIBUTIONS: 'My last contribution',
  MY_NEXT_CONTRIBUTIONS: 'My next contribution',
  MY_CONTRIBUTION_SCHEDULE: 'My Contribution Schedule',
  RECURRING: 'Recurring',
  START: 'Start:',
  FUNDING_ROUNDS: 'Funding Rounds',
  TRIBE_CONTRIBUTIONS: 'Tribe Contributions',
  CREATE_NEW_FUNDING_FOUND: 'Create New Funding Round',
  OUR_THIRD_FUNDING_ROUND: 'Our Third Funding Round',
  ACTIVE: 'ACTIVE',
  DAYS_LEFT: 'Days left',
  DETAILS: 'Details',
  MY_CONTRIBUTIONS: 'My Contributions',
  MANAGE: 'Manage',
  MIN_TO_PARTICIPATE: 'Min to participate',
  MAX_TO_PARTICIPATE: 'Max to participate',
  DEADLINE: 'Deadline',
  ABOUT: 'About',
  ...
  MARK_UPCOMING_CONTRIBUTIONS:
    'Mark the upcomin contribution(s) that you would like to permanently remove from your schedule.',
  MARK_UPCOMING_CONTRIBUTIONS2:
    'Contributions can removed up to X business days before the scheduled date.',
  STATUS: 'Status',
  SUCCESS: 'Success',
  SCHEDULED: 'Scheduled',
  ...
  MANAGE_PROFILE_AND_SETTINGS: 'Manage Profile & Settings',
  YOUR_TRIBES: 'Your Tribes',
