...
export const en = {
  ...
  TRIBE_GOALS: 'Featured tribe goals',
  LEARN_TOGETHER: 'Experience & Learn Together',
  BUILD_WEALTH: 'Build Wealth Through Ownership',
  ...
  CUSTOMIZE_SETUP: 'Want to customize your setup? Switch to our custom package',
  ...
  CITY: 'City',
  ENTER_CITY: 'Enter you city',
  STATE: 'State',
  ENTER_STATE: 'Enter you state',
  ZIP: 'Zip',
